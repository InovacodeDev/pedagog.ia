...
* **Estados:**
    * *Processing:* Exibe animação `pulse` e barra de progresso indeterminada.
    * *Action Required:* Borda `Warning` (Amarelo/Laranja) se o OCR tiver baixa confiança.
    * *Success:* Ícone `CheckCircle` em `Secondary` (Teal).
