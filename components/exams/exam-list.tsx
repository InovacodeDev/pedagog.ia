            ...
            exams.map((exam) => {
              ...
              return (
                <TableRow key={exam.id}>
                  ...
                  <TableCell>{isManual ? '--' : exam.questions_list.length - 2 || '--'}</TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem disabled={isManual} className={isManual ? 'opacity-50' : ''}>
                          <FileDown className="mr-2 h-4 w-4" /> Exportar PDF
                        </DropdownMenuItem>
                        <DropdownMenuItem onClick={() => handleDuplicate(exam.id)} disabled={isManual} className={isManual ? 'opacity-50' : ''}>
                          <Copy className="mr-2 h-4 w-4" /> Duplicar
                        </DropdownMenuItem>
                        <DropdownMenuItem
                          disabled={isManual || exam.correction_count > 0}
                          className={
                            isManual || exam.correction_count > 0 ? 'opacity-50 cursor-not-allowed' : ''
                          }
                          asChild={!isManual && exam.correction_count === 0}
                        >
                          {!isManual && exam.correction_count === 0 ? (
