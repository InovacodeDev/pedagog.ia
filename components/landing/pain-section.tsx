        ...
        <div className="grid gap-8 md:grid-cols-3">
          {PAINS.map((pain, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="flex flex-col items-center text-center space-y-4 p-8 rounded-2xl border-2 border-transparent hover:border-slate-200 bg-white shadow-md transition-colors duration-300 group"
            >
              <div className="p-4 rounded-full bg-slate-100 text-slate-500 mb-2">
