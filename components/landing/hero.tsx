...
export function Hero() {
  return (
    <section className="relative overflow-hidden pt-32 pb-20 lg:pt-40 lg:pb-32 bg-slate-50 dark:bg-slate-950">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
          ...
          >
            <div className="space-y-4">
              <div className="inline-flex items-center rounded-full border border-indigo-200 bg-indigo-50 px-3 py-1 text-sm font-medium text-indigo-800 dark:border-indigo-800 dark:bg-indigo-950/50 dark:text-indigo-300">
                <Sparkles className="mr-2 h-3.5 w-3.5 text-indigo-600 dark:text-indigo-400" />
                Nova IA 2.0 Disponível
              </div>
              <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none font-display text-slate-900 dark:text-white leading-tight">
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-white/50 dark:border-slate-800/50 p-8 rounded-3xl shadow-2xl dark:shadow-none">
                  <Brain className="w-24 h-24 text-indigo-600 dark:text-indigo-400" />
              ...
              <motion.div
                ...
                className="absolute top-10 right-10 md:top-0 md:right-10 bg-white dark:bg-slate-800 p-4 rounded-xl shadow-lg border border-slate-100 dark:border-slate-700"
              >
                <FileText className="w-8 h-8 text-teal-500" />
                <div className="h-2 w-12 bg-slate-100 dark:bg-slate-700 rounded mt-2" />
              </motion.div>

              <motion.div
                animate={{ y: [-10, 10, -10], x: [-5, 0, -5] }}
                transition={{ repeat: Infinity, duration: 5, delay: 1 }}
                className="absolute bottom-10 left-10 md:bottom-20 md:left-0 bg-white dark:bg-slate-800 p-4 rounded-xl shadow-lg border border-slate-100 dark:border-slate-700"
              >
              ...
              <motion.div
                ...
                className="absolute -z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[140%] h-[140%] border border-indigo-100/50 dark:border-indigo-900/30 rounded-full opacity-50"
              />
            </motion.div>
          </motion.div>
        </div>
